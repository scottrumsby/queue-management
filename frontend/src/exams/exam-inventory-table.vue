      ...
      <b-form inline class="ml-3">
        ...
        <b-input-group class="ml-3" v-if="!showExamInventoryModal">
          ...
          <b-btn-group horizontal class="ml-2 pt-2">
            ...
            <b-btn size="sm"
                   :pressed="inventoryFilters.returnedFilter==='holding'"
                   @click="setFilter({type:'returnedFilter', value:'holding'})"
            ...
            <template v-if="officeFilter == userOffice || officeFilter == 'default'">
              ...
              <template v-else>
                ...
                <!--<b-dropdown-item v-else
                                 size="sm"
                                 @click="updateCalendarBooking(row.item)">Update Booking</b-dropdown-item>-->
              </template>
              <b-dropdown-item size="sm"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['calendar_events', 'exam_inventory', 'is_liaison_designate', 'role_code', ]),
      ...mapState([
        'bookings',
        'calendarSetup',
        'calendarEvents',
    ...
    methods: {
      ...
      returnExam(item) {
        let exam = item
        exam.exam_returnd_date = ''
        this.actionedExam = exam
