  ...
  <b-modal v-model="showModal"
    ...
    <div v-if="exam">
      ...
      <b-form v-if="showAllFields">
        ...
        <b-form-row>
          <b-col :col="!this.fields.exam_received" :cols="this.fields.exam_received ? 3 : '' ">
            <b-form-group>
              ...
              <b-select id="exam_received"
                        ...
                        v-model="fields.exam_received" />
            </b-form-group>
          </b-col>
          <b-col v-if="fields.exam_received">
            <b-form-group>
      ...
      <b-form v-if="!showAllFields">
        ...
        <b-form-row>
          ...
          <b-col v-if="fields.exam_received" cols="6">
            <b-form-group>
              <label class="my-0">Exam Received</label><br>
              <DatePicker v-model="fields.exam_received_date"
                          id="exam_received_date"
                          input-class="form-control"
                          class="w-100 my-0 less-10-mb"
...
<script>
  ...
  export default {
      ...
      allowSubmit() {
        if (this.exam) {
          ...
          for (let key of fields) {
            if (this.fields[key] != this.exam[key]) {
              fieldsEdited = true
              break
            }
          }
          return fieldsEdited && !!this.fields.office_id
        }
        return false
      },
      exam() {
    ...
    methods: {
      ...
      populateForm() {
        this.setSelectedExam(this.exam)
        let examCopy = Object.assign({}, this.exam)
        Object.keys(examCopy).forEach( key => {
          if (typeof examCopy[key] === 'string' || typeof examCopy[key] === 'number') {
            Vue.set(
              this.fields,
              key,
              examCopy[key]
      ...
      submit() {
        ...
        if (!this.fields.exam_received && this.exam.exam_received) {
      ...
      updateExamReceived(e) {
        ...
        if (!e) {
          Vue.delete(this.fields, 'exam_received_date')
        }
      },
    },
  }
