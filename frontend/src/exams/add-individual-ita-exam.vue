<template>
  <b-modal v-model="modal"
    ...
    <CaptureIndITABase v-if="step <= 3"  />
    <ConfirmExamCapture v-if="step==4" :submitMsg="submitMsg" />
  </b-modal>
</template>
...
<script>
  ...
  import ConfirmExamCapture from './confirm-exam-capture'

  export default {
    name: 'AddIndividualItaExam',
    components: { CaptureIndITABase, ConfirmExamCapture },
    data() {
      return {
        submitMsg: ''
      }
